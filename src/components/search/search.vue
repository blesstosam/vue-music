<template>
    <div class="search">
        <div class="search-box-wrapper">
            <SearchBox @query="getQuery" ref="searchBox"></SearchBox>
        </div>
        ...
        <div ref="searchResult" class="search-result" v-show="query">
            <Suggest ref="suggest" @select="saveSearch" @scrollList='blurInput' :query="query"></Suggest>
        </div>

        <Confirm ref="confirm" text="是否清空所有记录"
